          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 xl:gap-24">
            ...
            <div className="lg:col-span-5 space-y-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-black border border-white/10 flex items-center justify-center text-gray-500 group-hover:text-[#00ff66] group-hover:border-[#00ff66]/40 transition-all">
                    <Mail size={24} />
                  </div>
                  <div>
                    <p className="text-[10px] text-gray-600 font-tech uppercase tracking-widest mb-1">Secure Email</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-[10px] text-gray-600 font-tech uppercase tracking-widest mb-1">Voice Channel</p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <a href="https://www.linkedin.com/in/sumit-chauhan-a4ba98325/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-4 p-8 bg-neutral-950 border border-white/5 rounded-3xl hover:border-[#00ff66]/30 transition-all group">
                     <Linkedin className="text-gray-700 group-hover:text-[#00ff66] transition-colors" size={24} />
                     <span className="text-[10px] font-tech text-gray-600 uppercase tracking-widest">LinkedIn</span>
                  </a>
                  <a href="https://github.com/halloffame12" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-4 p-8 bg-neutral-950 border border-white/5 rounded-3xl hover:border-[#00ff66]/30 transition-all group">
                     <Github className="text-gray-700 group-hover:text-[#00ff66] transition-colors" size={24} />
                     <span className="text-[10px] font-tech text-gray-600 uppercase tracking-widest">GitHub</span>
                  </a>
                </div>
              </div>
              {/* System Status Display */}
              <div className="bg-black/40 border border-[#00ff66]/10 p-8 rounded-[2.5rem] relative overflow-hidden group">
                 ...
                 <div className="relative z-10 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between text-[10px] font-tech text-gray-600 uppercase tracking-widest">
                    ...
                    <div className="pt-4 border-t border-white/5">
                       <p className="text-[9px] text-gray-700 font-tech leading-relaxed uppercase tracking-widest">
          ...
          >
            <div className="bg-neutral-950 p-8 sm:p-12 rounded-[3.5rem] border border-white/5 relative shadow-2xl">
              <div className="mb-12">
                 ...
                 <p className="text-gray-600 text-sm font-tech uppercase tracking-widest">Enter data parameters below</p>
              </div>
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label htmlFor="name" className="text-[10px] font-tech uppercase tracking-[0.3em] text-gray-600 ml-1">Identity.Name</label>
                    <input
                      id="name"
                      type="text"
                      name="name"
                      ...
                      className="w-full bg-black border border-white/5 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#00ff66]/50 transition-all text-white placeholder:text-gray-800 text-sm font-tech"
                    />
                    <ValidationError prefix="Name" field="name" errors={state.errors} />
                  </div>
                  <div className="space-y-3">
                    <label htmlFor="email" className="text-[10px] font-tech uppercase tracking-[0.3em] text-gray-600 ml-1">Identity.Email</label>
                    <input
                      id="email"
                      type="email"
                      name="email"
                ...
                <div className="space-y-3">
                  <label htmlFor="message" className="text-[10px] font-tech uppercase tracking-[0.3em] text-gray-600 ml-1">Transmission.Payload</label>
                  <textarea
                    id="message"
                    name="message"
                    rows={6}
                    ...
                    className="w-full bg-black border border-white/5 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#00ff66]/50 transition-all text-white placeholder:text-gray-800 resize-none text-sm font-tech"
                  />
              ...
              <div className="mt-12 pt-10 border-t border-white/5 flex items-center justify-center gap-6 opacity-30 text-[9px] font-tech text-gray-500 uppercase tracking-[0.2em]">
